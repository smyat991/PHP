<?php
    ...
    $brands = $stmt->fetchAll();
        ...
        $sql1 = "SELECT * FROM subcategories ORDER BY id DESC";
        $stmt1 = $conn->prepare($sql1);

        $stmt1->execute();

        $subcategories = $stmt1->fetchAll();
                ...
                <div class="tile-body">
                    <form action="item_add.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="code_id" name="codeno">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" id="price_id" name="price">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="discount_id" name="discount">
                            </div>
                        </div>
