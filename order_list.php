...
?>
    ...
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb side">
            <a href="order_new.php" class="btn btn-outline-primary">
                ...
                <div class="tile-body">
                    ...
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <a class="nav-link" id="nav-cancel-tab" data-toggle="tab" href="#nav-cancel" role="tab" aria-controls="nav-cancel" aria-selected="true">Order-Cancel</a>
                        </div>
                    </nav>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="orderstatuschange.php?id=<?= $pending_id ?>&status=0" class="btn btn-outline-success">
                                                    <i class="icofont-ui-check"></i>
                                                </a>
                                                <a href="orderstatuschange.php?id=<?= $pending_id ?>&status=1" class="btn btn-outline-danger">
